<template>
    <nav class="
        ...
        w-full
        z-50
    " :class="{ 'bg-white dark:bg-neutral-800 text-black': toggle }">
        <div class="
            w-full
            h-16
            flex
        ...
        ">
            ...
            ">
                ...
                <navbar-lang></navbar-lang>

                <navbar-theme></navbar-theme>

                <navbar-social :href="socialLinks.github">
                ...
                <navbar-social :href="socialLinks.linkedin">
...
import navbarIcon from './components/navbar-icon.vue'
import navbarLink from './components/navbar-link.vue'
import navbarSocial from './components/navbar-social.vue'
import navbarTheme from './components/navbar-theme.vue'
import navbarLang from './components/navbar-lang.vue'
